...
public class WikiResultRecyclerAdapter extends RecyclerView.Adapter<WikiResultRecyclerAdapter.ViewHolder> {
    ...
    public WikiResultRecyclerAdapter(List<Item> items, OnItemClickListener listener) {
        mItems = items;
        mListener = listener;
    }
