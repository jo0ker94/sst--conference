package com.example.karlo.learningapplication.modules.calendar;
...
public class CalendarActivity  extends Activity
    ...
    private void addToCalendar(Calendar service) {
        ...
        event[0].setRecurrence(Arrays.asList(recurrence));

        EventAttendee[] attendees = new EventAttendee[] {
                new EventAttendee().setEmail("znidareck@gmail.com"),
        };
